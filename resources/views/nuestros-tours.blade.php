...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets-web/css/magic-input.min.css')}}">
...
<body>
	...
	<section class="secc-slider-banner">
		<div class="container-fluid px-0">
			<div class="div-slider-banner div-secc-banner">
    		<div class="div-absolute-banner">
    			<h1 class="titulo-banner text-center">NUESTROS TOURS</h1>
    		</div>
    	</div>
		</div>
		<div class="conten-form-top-home">
			<div class="div-form-home d-flex align-items-center flex-wrap justify-content-between">
				<div class="custom-select custom-select-tours mb-2 mb-sm-3 mb-lg-0">
				  <select>
				    <option value="0">Look for specific tour</option>
				...
				<div class="custom-select custom-wrapper-tour mb-2 mb-sm-0">
				  <select>
				...
				<div class="wrapper mb-2 mb-sm-3 mb-lg-0 custom-wrapper-tour">
					<input type="text" id="datepicker" autocomplete="off" placeholder="When?" class="input-date">	
					<i class="material-icons icon-select-date">today</i>
				</div>
				<button type="button" class="btn btn-style-find">Find my trip</button>
			</div>
		</div>
	</section>
	...
	<section>
		<div class="container">
			<p class="p-regular-plomo-exterior">You can narrow down your search choosing attributes that suite your needs:</p>
			<div class="row mx-0 mt-4">
				<div class="col-sm-6 col-md-4 col-lg-3 mb-3">
					<label class="p-regular-plomo-exterior d-flex align-items-center"><input type="checkbox" class="mgc mgc-success me-2" /> Archeological sites</label>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 mb-3">
					<label class="p-regular-plomo-exterior d-flex align-items-center"><input type="checkbox" class="mgc mgc-success me-2" /> Archeological sites</label>
				</div>
	...
	<section class="secc-top-externas">
		<div class="container">
				<h3 class="text-center titulos-medium-style mt-0">OUR TOURS FOR YOU</h3>
				<div class="row mx-0 justify-content-end mt-5">
					<div class="col-lg-11 col-xl-10 px-0">
						<div class="row mx-0 justify-content-center justify-content-lg-end align-items-center">
							<div class="col-lg-3 text-center text-lg-end mb-4 mb-lg-0">
								<p class="p-regular-plomo-exterior my-0 pe-3">Sort by:</p>
							</div>
							<div class="col-sm-6 col-md-4 col-lg-3 px-0 mt-1 mt-md-0">
								<button class="btn btn-collapse">
									<i class="material-icons icon-collapse me-3">remove_red_eye</i>
									Date
								</button>
							</div>
							<div class="col-sm-6 col-md-4 col-lg-3 px-0 mt-1 mt-md-0">
								<button class="btn btn-collapse">
									<i class="material-icons icon-collapse me-3">local_offer</i>
									Price low to high
								</button>
							</div>
							<div class="col-sm-6 col-md-4 col-lg-3 px-0 mt-1 mt-md-0">
				...
				<div class="row mx-0 justify-content-center align-items-center mt-3 mt-sm-5">
					<div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
					    ...
					    |-->
					    <div class="card-body card-padding-left-right-home">
					      <h5 class="card-title my-0">ESTE ES EL NOMBRE DEL TOUR</h5>
					      <h6 class="card-subtitulos mb-0 mt-1">Difficulty - Make you cry</h6>
					      <p class="card-text mt-3 mb-0">
					      	Lorem ipsum dolor sit amet, consetetur sadipscing elitr consetetur sadipscing elitr
					      </p>
					      <div class="card-precios-absolute text-sm-end text-md-start">
					      	<p class="my-0 p-precio-semibold p-color-verde">
					      		$127
					      	</p>
					      	<p class="my-0 p-precio-semibold p-color-plomo">
					      		<del>$127</del>
					      	</p>
					      </div>
					    </div>
					    <div class="card-footer">
					      <div class="row mx-0 align-items-center">
					      	<div class="col-6 text-end py-0 px-3">
					      		<p class="mb-0 p-hora-pais">
