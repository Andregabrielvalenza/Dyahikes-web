		...
		<div class="container-fluid px-0">
			<div class="div-slider-banner div-secc-banner">
	    		<div class="div-absolute-banner">
	    			...
	    			<p class="p-medium-blanco-banner mt-2 w-100 text-center">WE’RE PROCESSING YOUR ORDER</p>
	    		</div>
	    	</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row mx-0 justify-content-center">
				<div class="col-md-8 col-lg-6 text-center">
					<p class="text-center p-medium-negro px-0">Our staff will be in contact with you as soon as possible.</p>
