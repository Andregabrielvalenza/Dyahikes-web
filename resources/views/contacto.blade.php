...
<body>
		...
		<div class="container-fluid px-0">
			<div class="div-slider-banner div-secc-banner">
	    		<div class="div-absolute-banner">
	    			<h1 class="titulo-banner text-center w-100">CONTACT US</h1>
	    			<div class="div-linea-blanca mt-2"></div>
	    			<p class="p-medium-blanco-banner mt-2 w-100 text-center">WE´RE ALL EARS</p>
	    		</div>
	    	</div>
		</div>
	</section>
	...
	<section class="secc-top">
		<div class="container-fluid px-sm-0">
			<div class="row mx-0">
				<div class="col-md-6 px-0 px-sm-5 px-md-3 px-lg-5">
					<form>
						<div class="row mx-0 justify-content-center">
							<div class="col-sm-6 px-0 px-sm-1 mb-2">
								<input type="text" name="First" placeholder="First name" class="input-email w-100">
							</div>
							<div class="col-sm-6 px-0 px-sm-1 mb-2">
								<input type="text" name="Last" placeholder="Last name" class="input-email w-100">
							</div>
							<div class="col-12 px-0 px-sm-1 mb-2">
								<input type="email" name="Email" placeholder="E-mail" class="input-email w-100">
							</div>
							<div class="col-12 px-0 px-sm-1 mb-2">
								<textarea class="input-tarea" placeholder="What can we help you with?"></textarea>
							</div>
							<div class="col-xl-10 text-center px-0 px-sm-2">
								<button class="btn btn-style-find btn-widht-contac">Mi viaje perfecto</button>
							</div>
						</div>
					</form>
				</div>
				<div class="col-md-6 px-0 mt-5 mt-md-0">
					<div class="div-fondo-contacto">
						<ul style="list-style: none;" class="ps-0">
							<li class="p-medium-negro px-0 mb-3 text-center text-md-start">
								Urb. Kennedy “A” G-7 Calle Topacio Wanchaq Cusco-Peru  
							</li>
							<li class="p-medium-negro px-0 mb-3 text-center text-md-start">
								184 24 1705 - 011 51 969 738 146
							</li>
							<li class="p-medium-negro px-0 mb-3 text-center text-md-start">
								051  011 - 51 - 800668 6165
							</li>
							<li class="p-medium-negro px-0 text-center text-md-start">
								info@dayhikesperu.com
							</li>
						</ul>
					</div>
				</div>
