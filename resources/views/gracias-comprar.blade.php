		...
		<div class="container-fluid px-0">
			<div class="div-slider-banner div-secc-banner">
	    		<div class="div-absolute-banner">
	    			<h1 class="titulo-banner text-center w-100">AWESOME!</h1>
	    			<div class="div-linea-blanca mt-2"></div>
	    			<p class="p-medium-blanco-banner mt-2 w-100 text-center">WE’RE LOOKING FORWARD TO TRAVEL WITH YOU</p>
	    		</div>
	    	</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row mx-0 justify-content-center">
				<div class="col-md-8 col-lg-6 text-center">
					<p class="text-center p-medium-negro px-0">Please check your e-mail for confirmation. Our staff will be in contact with you soon for additional coordinations.</p>
					<p class="p-regular-plomo-exterior">Note: Please add info@dayhikesperu.com to your contacts to avoid our response going to the spam folder</p>
					<button class="btn btn-style-find btn-widht-abaout mt-5">Keep exploring</button>
				</div>
			</div>
		</div>
	</section>
